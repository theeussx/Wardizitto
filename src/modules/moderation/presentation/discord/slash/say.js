...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    ) // Garante que só canais de texto do servidor apareçam
  ...
  async execute(interaction) {
    ...
    try {
      ...
      await interaction.reply({
        content: `✅ Mensagem enviada com sucesso em ${canalDestino}.`,
        ephemeral: true,
      });
    } catch (error) {
      interaction.client.services.logger.error('Erro ao enviar a mensagem:', error);
      await interaction.reply({
        content: '⚠️ Ocorreu um erro ao tentar enviar a mensagem.',
        ephemeral: true,
      });
    }
  },
