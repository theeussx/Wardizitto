...
const emojis = require('../../../../../core/config/emojis.json');
...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addStringOption((option) =>
      option.setName('input').setDescription('Texto para arte ASCII').setRequired(true),
    ),
  ...
  async execute(interaction) {
    ...
    figlet(input, async (err, data) => {
      if (err) {
        interaction.client.services.logger.error('Erro no ASCII:', err);
